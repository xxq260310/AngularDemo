angular.module("MyAngular",
    ["ngRoute", "myListController", "myServiceModule", "myDirectiveModule", "myDirectiveCtrl1", "myDirectiveCtrl2", "myEditCtrl", "myDeleteCtrl", "filterCtrlModule", "myDetailsCtrl", "myTransCludeCtrl", "limitToExample", "orderByExample", "selectExample"])
    .config(["$routeProvider", "$locationProvider", function ($routeProvider, $locationProvider) {
        ...
        .when("/UserProfiles/Details/:id", { templateUrl: function (params) { return '/UserProfiles/Details/' + params.id }, controller: "DetailsController" })
            ...
            .when("/UserProfiles/CreateIsolateScopeInDirective", { templateUrl: "/UserProfiles/CreateIsolateScopeInDirective" })
